...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-knhv6ok.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-knhv6ok.containers.anotherwebservice.com/
...
```
git clone git@github.com:ryzewtf/container-knhv6ok.git
cd container-knhv6ok
```
...
```
docker attach container-knhv6ok
```
